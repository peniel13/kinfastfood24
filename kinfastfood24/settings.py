"""
Django settings for kinfastfood24 project.
...
SECRET_KEY = 'django-insecure-2hu2a_p^d2wg$q6=9xsfifx^6qrzz2lm$&2x)ytf5h^ca08du%'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["kinfastfood24.onrender.com", '127.0.0.1', 'localhost']
...
ROOT_URLCONF = 'kinfastfood24.urls'
...
WSGI_APPLICATION = 'kinfastfood24.wsgi.application'
