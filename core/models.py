...
class Product(models.Model):
    ...
    def save(self, *args, **kwargs):
        # Si le prix est défini, on calcule la commission (30%)
        if self.price is not None:
            # Conversion de la commission en Decimal pour éviter les erreurs de float
            commission_rate = Decimal('0.30')  # 30% de commission (en Decimal)
